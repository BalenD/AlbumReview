...
namespace AlbumsReviewRESTApi.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<AlbumsReviewRESTApiContext>(x => x.UseSqlServer(connectionString, y => y.MigrationsAssembly("AlbumsReviewRESTApi.Data")));
